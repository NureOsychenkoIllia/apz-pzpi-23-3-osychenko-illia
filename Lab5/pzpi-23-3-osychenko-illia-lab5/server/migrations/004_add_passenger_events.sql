...
WHERE (SELECT id FROM trips WHERE status = 'completed' ORDER BY id LIMIT 1) IS NOT NULL;
...
WHERE (SELECT id FROM trips WHERE status = 'in_progress' ORDER BY id LIMIT 1) IS NOT NULL;
...
WHERE (SELECT id FROM trips WHERE status = 'boarding' ORDER BY id LIMIT 1) IS NOT NULL;
